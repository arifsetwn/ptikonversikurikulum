...
export const ProfilLulusanSection: React.FC = () => {
  ...
  const getPLIcon = (id: string) => {
    if (id === 'pl-1') return <GraduationCap className="w-5 h-5 text-blue-600" />;
    if (id === 'pl-2') return <Cpu className="w-5 h-5 text-indigo-600" />;
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all overflow-hidden bg-white ${
                  isExpanded
                    ? 'border-blue-500/80 shadow-xl ring-2 ring-blue-500/10'
              ...
              >
                ...
                <div className="p-6 border-b border-slate-100 bg-slate-50/60">
                  <div className="flex items-center justify-between mb-3">
                    <span className="px-3 py-1 bg-blue-100/80 text-blue-800 font-extrabold rounded-xl text-xs">
                      {pl.kode}
                    </span>
                      ...
                      <AnimatePresence initial={false}>
                        {visibleCareers.map((career, idx) => (
                          <motion.li
                            ...
                            className="flex items-start gap-2 text-slate-800 font-medium"
                          >
