...
export const LandingPage: React.FC<LandingPageProps> = ({ onStartSimulation }) => {
  return (
    <div className="bg-slate-50 text-slate-900 font-sans">
      ...
      {/* Footer CTA Section */}
      <section className="py-20 bg-slate-950 text-white text-center border-t border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-blue-500/15 text-blue-300 border border-blue-400/25 mb-4 backdrop-blur-md">
          ...
          <button
            ...
            className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs sm:text-sm rounded-xl shadow-xl shadow-blue-600/25 active:scale-[0.98] transition-all inline-flex items-center gap-2 cursor-pointer group"
          >
