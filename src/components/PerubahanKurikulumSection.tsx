  ...
  return (
    <section id="perubahan" className="py-16 bg-slate-50 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header (Eyebrow #3 of max 3 allowed) */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="px-3.5 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-bold uppercase tracking-wider">
            Rincian Perubahan
          </span>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 mt-2 tracking-tight">
            Catatan Perubahan Kurikulum (2022 ke 2026)
          </h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {GENERAL_CHANGES.map((item, idx) => (
              <div key={idx} className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm card-taste-hover flex flex-col justify-between">
                <div>
            ...
            <div>
              <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <span className="text-xs text-slate-500 font-medium">
                  * Pemetaan nama mata kuliah & perpindahan semester.
                </span>
              </div>
          ...
          {activeTab === 'baru' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-indigo-50/80 border border-indigo-200/80">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-extrabold bg-indigo-200/80 text-indigo-900 uppercase">
                  Semester 7 • 2 SKS
                </span>
                <h4 className="font-extrabold text-indigo-950 text-base mt-2">Life Skills</h4>
                <p className="text-xs text-indigo-900/90 mt-1 leading-relaxed font-medium">
          ...
          {activeTab === 'wajib' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-emerald-50/80 border border-emerald-200/80">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-extrabold bg-emerald-200/80 text-emerald-900 uppercase">
                  Sebelumnya MK Pilihan ke Wajib Semester 4 (2 SKS)
                </span>
              ...
              <div className="p-5 rounded-2xl bg-emerald-50/80 border border-emerald-200/80">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-extrabold bg-emerald-200/80 text-emerald-900 uppercase">
                  Sebelumnya MK Pilihan ke Wajib Semester 6 (3 SKS)
                </span>
