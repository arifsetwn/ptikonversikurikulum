      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-6">
            <Layers className="w-5 h-5 text-[#2F3185]" />
            ...
            <div>
              <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <input
                  ...
                  className="w-full max-w-md px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-[#2F3185]"
                />
              ...
              <div className="overflow-x-auto border border-slate-200 rounded-2xl">
                <table className="w-full text-left text-xs">
                  <thead className="bg-[#1E205C] text-white font-bold uppercase tracking-wider">
                    <tr>
                    ...
                    {filteredNameChanges.map((item, idx) => (
                      <tr key={idx} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="py-3 px-4 text-center">
                          <ArrowRight className="w-4 h-4 text-[#1CBDB3] inline-block" />
                        </td>
                        <td className="py-3 px-4 font-extrabold text-[#2F3185]">
                          <span>{item.newName}</span>
                          {item.newSem && (
                            <span className="ml-2 px-2 py-0.5 bg-[#2F3185]/10 text-[#2F3185] rounded text-[10px] font-black border border-[#2F3185]/20">
                              {item.newSem}
                            </span>
                          )}
                        </td>
                ...
                <tbody className="divide-y divide-slate-100 font-medium">
                  {SKS_CHANGES.map((item, idx) => (
                    <tr key={idx} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3 px-4 text-center font-extrabold text-[#2F3185]">
                        <span className="px-2.5 py-0.5 bg-[#2F3185]/10 text-[#2F3185] rounded-full font-black">
                          {item.newSks} SKS
                        </span>
                      </td>
                      <td className="py-3 px-4 text-slate-600 font-medium">{item.note || '-'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {activeTab === 'baru' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-[#2F3185]/[0.05] border border-[#2F3185]/20">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-black bg-[#2F3185] text-white uppercase">
                  Semester 7 • 2 SKS
                </span>
                <h4 className="font-extrabold text-[#2F3185] text-base mt-2">Life Skills</h4>
              ...
              <div className="p-5 rounded-2xl bg-[#2F3185]/[0.05] border border-[#2F3185]/20">
                ...
                <h4 className="font-extrabold text-[#2F3185] text-base mt-2">Seminar Proposal</h4>
                <p className="text-xs text-slate-700 mt-1 leading-relaxed font-medium">
          ...
          {activeTab === 'wajib' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-[#1CBDB3]/15 border border-[#1CBDB3]/30">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-black bg-[#159B93] text-white uppercase">
                  Sebelumnya MK Pilihan → Kini Wajib Semester 4 (2 SKS)
                </span>
                <h4 className="font-extrabold text-[#159B93] text-base mt-2">Kecerdasan Buatan (AI)</h4>
                <p className="text-xs text-slate-700 mt-1 leading-relaxed font-medium">
              ...
              <div className="p-5 rounded-2xl bg-[#1CBDB3]/15 border border-[#1CBDB3]/30">
                ...
                <h4 className="font-extrabold text-[#159B93] text-base mt-2">Internet of Things (IoT)</h4>
                <p className="text-xs text-slate-700 mt-1 leading-relaxed font-medium">
